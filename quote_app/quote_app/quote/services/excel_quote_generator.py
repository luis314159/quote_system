...
# # For PDF conversion - cross-platform solution
...
#     def _excel_to_html(self, excel_data):
#         """
#         Convierte el Excel en HTML usando pandas
#         Este es un paso intermedio para luego generar el PDF
#         """
...
#                     .table th {{ padding-top: 12px; padding-bottom: 12px; text-align: center; background-color: #E0E0E0; }}
#                 </style>
#             </head>
#             <body>
#                 <h2>Quote #{self.ws[self.cell_refs['quote_number']].value}</h2>
#                 <p><strong>Project:</strong> {self.ws[self.cell_refs['project_name']].value}</p>
#                 <p><strong>Date:</strong> {self.ws[self.cell_refs['date']].value}</p>
#                 <p><strong>Valid Until:</strong> {self.ws[self.cell_refs['valid_until']].value}</p>
#                 {html}
#                 <div style="margin-top: 30px;">
#                     <p><strong>Delivery:</strong> 6 weeks or advise required</p>
#                     <p><strong>Payment Terms:</strong> Net 15 after shipping</p>
#                     <p><strong>Incoterms:</strong> Fob Grupo ARGA Plant at Chihuahua</p>
#                     <p><strong>Notes:</strong> We can provide logistic service Door to Door including customs clerance. To be quoted base on needs and weight.</p>
#                 </div>
#             </body>
#             </html>
#             """
...
#         """
#         Genera un archivo PDF a partir del Excel utilizando WeasyPrint
#         WeasyPrint es una solución multiplataforma que funciona en Windows, macOS y Linux
#         """
#         logger.info("Generating PDF quote")
        
#         try:
#             # Primero generamos el Excel
#             excel_data = self.generate_excel()
            
#             # Convertir el Excel a HTML
#             html_content = self._excel_to_html(excel_data)
...
#             logger.info("PDF quote generated successfully")
